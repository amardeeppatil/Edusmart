 ...
 <ul class="col-lg-12">
  ...
  <div class="dropdown-menu noti noti1 pull-left bdr" role="menu">
   ...
   <c:forEach items="${sessionScope.messageList}" var="msgObj">  
                <div class="col-lg-2 col-sm-2 col-xs-2 col-md-2 events"> <img alt="" src="images/user.png" class="img-responsive"> </div>
                <div class=" events">
          ...
          <div class="content">
           ...
           <c:if test="${not empty sessionScope.notificationList}">
             <c:forEach var="notificationListObj" items="${sessionScope.notificationList}" varStatus="status">
              <div class="col-lg-2 col-sm-2 col-xs-2 col-md-2 events"> <img alt="" src="images/user.png" class="img-responsive"> 
           </div>
  ...
  <li class="col-md-8">
   ...
   <li class=""> <img src="images/symbol.png"  class="ic"></li>
