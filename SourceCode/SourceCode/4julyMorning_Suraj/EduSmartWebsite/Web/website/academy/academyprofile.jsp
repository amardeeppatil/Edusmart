                    ...
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <a href="#" class="pull-right share" data-toggle="tooltip" title="Share" data-placement="bottom"> <img src="images/plane.png"></a> </div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div id="" class="panel-group">
            <div class="panel panel-default" id="panel1">
              <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                  <div class="col-md-2 col-xs-3   col-lg-2 firends1"> <img src="images/user.png" class="featurette-image img-responsive"></div>
                  <div class="col-lg-10 profile-new">
                    <p class="lead "> <a href="#"><s:property value="academy.AcademyName"/></a> <c:out value=" ${about.title}  "/> </p>
