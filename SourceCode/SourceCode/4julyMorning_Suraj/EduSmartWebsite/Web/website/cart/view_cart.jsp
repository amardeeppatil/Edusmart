...
<div class="container-fluid">
	...
	<div class="span12">
		<table class="table  pro-cart" style="border: none !important;">
			<thead>
				<tr>
					<th style="width:">Sr. No.</th>
					<th style="width: 22%; text-align: center;">Faculty</th>
					<th style="width: 22%; text-align: center;">Course Name (Year)</th>
					<th align="center" style="width: 22%; text-align: center;">Product</th>
					<th style="width: 22%; text-align: center;">Fee</th>
				</tr>
			</thead>
			<tbody>
				<s:iterator value="products" var="p">
						...
						<%
						UserProfileTB forName = UserProfileTB.class.cast(CommonController.getObjectByQuery("from UserProfileTB where Email='" + request.getAttribute("key.OwnerName").toString()+"'").get(0));
						%>

					<tr valign="middle">
						<td style="font-size: 14px; font-weight: bold;"><div
								class="sr"><%=i%></div></td>
						<td align="center" style="text-align: center;"><img
							src="img/team-member-1.jpg" class="img-circle" alt="" /><br>
							<br>
							<h3 class="title"><%-- <s:property value="key.OwnerName"/> --%><%=forName.getFName() + " " + forName.getLName()%></h3>
						</td>
						<td valign="middle"><div class="coursename">
								<h3>
									<s:property value="key.CourseName" />
								</h3>
							</div></td>
						<td><div class="edu-pro text-center" style="width: 128px;">
								<h4>
									<s:property value="key.ProductName" />
								</h4>
								<p>
									<%
										if ((request.getAttribute("key.StartDate").toString())
													.contains("/")) {
									%>
						...
						<td valign="middle"><div class="coursename img-circle">
								<h3>
									<p>
										Rs:
										<s:property value="key.TuitionFee" />
					...
					<!-- <tr valign="middle"></tr>
					<tr>
						<td colspan="10" style="font-size: 14px; font-weight: bold;">+</td>
					</tr> -->
					<%
						i++;
					%>
