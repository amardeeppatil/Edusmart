...
<script>
	$(document).ready(function() {
		...
		$("body").on("click", "div#addfaculty", function() {
			$.ajax({
				type : "GET",
				url : "addNewFaculty",
				success : function(data) {
	...
	function updateForm(ProductId) {
		$.ajax({
			type : "POST",
			url : "getFacultyById.action?facultyId=" + facultyId,
			success : function(data) {
...
<%-- 					<s:file name="profileFileUpload" onchange="readProfileURL(this);" /> --%>
				...
				<div class="span5 pull-right"
					...
					<div id="saveFaculty" class="btn btn-primary mrg1">New
						Faculty&raquo;</div>
				</div>
				<% } %>
				...
				<div class="row-fluid profile-menu">
					<ul class="nav nav-pills offset2"
						...
						<li class="active"><s:a action="facultylist">Faculty</s:a></li>
									...
									<div class="span2 text-center" style="margin-left: 0px;">
										...
										<div class="span2 text-center">
											...
											<div class="edu-pro">
												...
												<p>
													<% if((request.getAttribute("StartDate").toString()).contains("/")){%>
												...
												<p>
													<s:property value="FromTime" />
													to
													<s:property value="ToTime" />
												</p>
												<p>
													Rs:
													<s:property value="TuitionFee" />
												</p>
												<a href="addToCart?newProductId=<s:property value="ProductId" />" class="btn btn-primary">Add to Cart</a> <br>
												<br>
											</div>
											<p>
												<%-- <a href="#"
