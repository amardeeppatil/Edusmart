...
<header>
	<div class="row-fluid pull-left text-center">
		<div>
			<img src="img/edus.png" alt="" style="margin-top: 10px;" />
		...
		<div class="span4 pull-right">
			...
			<img src="img/icon-classroom.png" onMouseOver="shows('div3')"
				onMouseOut="hide('div3')" alt="smile" class="imgSmile cart-in" style="z-index:0;">

			<img src="img/icon-login.png" onMouseOver="shows('div2')"
				onMouseOut="hide('div2')" alt="smile" class="imgSmile log-in" style="z-index:0;">

			<img src="img/icon-cont.png" onMouseOver="shows('div1')"
			...
			<div id="div3" onMouseOver="shows('div3')" onMouseOut="hide('div3')"
				...
				<div class="body-pop">
						<div class="form-group">
							...
							<input type="email" name="UserName" class="form-control" placeholder="Enter Email"
                        		value="exce@gmail.com" required="required" style="width: 88%;"/>
						</div>
						<div class="form-group">
			 ...
			 <button type="button" class="btn btn-primary"><s:a href="registration.jsp">Sign Up</s:a></button>
				
					<button type="submit" class="btn bg-olive btn-block"><img src="img/icon-arrow.png" alt="" class="pull-right" /></button>
				</div>
				</form>
				<%
					} else {
				%>
					...
					<div class="bottom-pop">
						...
						<s:a href="%{logoutURL}" cssClass="btn btn-default btn-flat"><img src="img/icon-arrow.png" alt="" class="pull-right" /></s:a>
					</div>		
			...
			<div id="div1" onMouseOver="shows('div1')" onMouseOut="hide('div1')"
				...
				<div class="bottom-pop">
					<img src="img/icon-arrow.png" alt="" class="pull-right" />
				</div>
	...
	<div id="logo" class="span2 pull-left">
		<s:url id="viewHome" action="home"> </s:url><s:a href="%{viewHome}"><img src="img/symbol.png" alt=""
