...
function editac(){
	...
	alert(document.getElementById('AboutInfoId').innerHTML);
  ...
  <div id="" class="well  slide classes carousel bd">
    ...
    <i class="fa fa-pencil blue"></i></a></span>  
        <span  style="display:none;float:right;margin-right: 11px;" id="done"><i class="fa fa-floppy-o blue"></i></span>
   ...
   <h4><i class="fa fa-user"></i>   ABOUT  <span></span></h4>
      ...
      <div id="collapseOne" class="panel-collapse collapse in" onblur="editac()">
      <div  class="panel-body" >
        <p class="comment more"><p id="AboutInfoId"><s:property value="user.AboutInfo" /></p></p>
	<div class="pull-left">
      
     <a href="https://www.google.com/maps/place/Prestige+Point,+Madhukar+Chimanrav+Potnis+Rd,+Sathe+Colony,+Shukrawar+Peth,+Pune,+Maharashtra+411002,+India/@18.508066,73.855106,14z/data=!4m2!3m1!1s0x3bc2c06d40145179:0x1f2266903f700574?hl=en-US" target="_blank"> <img src="images/map.png" style="border:1px solid #ccc;padding:1px;margin:5px;height:80px;width:80px;"></a>
      </div>
        <p style="text-align:justify; margin-bottom: 0px;" ><p id="AddressId"><s:property value="user.PAddress1"/></p><br><br>
        </p>
        </div>
...
<!-- Faculty List -->
		...
		<div class="content">
			...
			<s:iterator var="count1" value="facultyList1">

				<div class="col-md-3 col-xs-4 col-lg-4 firends">
					<s:a action="facultyProfile">
						<img class="featurette-image img-responsive"
							src="<s:property value="ProfileImage" />">
...
<!-- Academy List -->	
	...
	<div class="carousel slide well-new classes well">
       ...
       <hr>
        ...
        <div class="col-md-3 col-xs-4 col-lg-4 firends"><s:a href="#"> <img class="featurette-image img-responsive" src="<s:property value="ProfileImage" />">
        <%-- <img class="featurette-image img-responsive"
							src="<s:property value="ProfileImage" />"> --%>
        <s:property value="CCity" /></s:a>
        </div>
</s:iterator>
           	</div> <!-- Indicators --> 
 ...
 <a href="#">See All</a></span>
        ...
        <hr>
    <div class="content">
     <div class="col-md-3 col-xs-4 col-lg-4 firends"><a href="#"> <img class="featurette-image img-responsive" src="images/students.jpg">
       </a>
        </div>
        <div class="col-md-3 col-xs-4 col-lg-4 firends"><a href="#"> <img class="featurette-image img-responsive" src="images/rec.jpg">
        </a>
        </div>
        <div class="col-md-3 col-xs-4   col-lg-4 firends"><a href="#"> <img class="featurette-image img-responsive" src="images/students.jpg">
         </a>
