    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-lg-11 profile-new">
          ...
          <p class="lead "><input type="email" class="form-control" id="" placeholder="Add titile here"></p>
          <p><input type="email" class="form-control" id="" placeholder="Selcet your date and time"></p>
        </div>
        ...
        <div class="well-update profile-new">
          ...
          <div class="col-lg-7 ">
            <h4 class="margin-top"><input type="email" class="form-control" id="" placeholder="Add titile here"></h4>
