...
<div class="jumbotron">
          ...
          <div class="panel with-nav-tabs panel-info " id="first"><br>
                ...
                <div class="panel-body">
                    <div class="tab-content"> 
                        ...
                        <form name="academyForm" id="academyAccountForm" class="" role="form" onsubmit="return checknextbtn1()">                      <div class="col-lg-3" style="text-align:center;">
           ...
           <a href="#" class="btn btn-xs btn-primary pull-right center-block" style="margin:10px;"> <span class=" btn-file "> <i class="fa fa-camera " style="color:#fff;"></i> Change Picture
            <!-- <input type="file"> -->
            <s:file name="user.ProfileImage" onchange="readProfileURL(this);"/>
            </span></a>
          ...
          <div class="col-lg-9">
            ...
            <div class="personal-bg">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="user.FName" id="FName" class="form-control input-lg" placeholder="*Name" >
                    <span id="errFName" class="text-danger"></span>
                  </div>
                </div>
              </div>
              <div class="form-group">
                <input type="text" name="user.DOB" id="DOB" class="form-control input-lg" placeholder="*Date of Birth" >
              </div>
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <div class="controls" style="width:100%; font-size: 15px;">
                      <label class="radio-inline ">
                        <input type="radio" name="user.Gender" id="inlineRadio1" value="Male">
                        Male </label>
                      <label class="radio-inline">
                        <input type="radio" name="user.Gender" id="inlineRadio2" value="Female">
                        Female </label>
                    </div>
                  </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group">
                    <select type="text" name="user.BloodGroup" id="BloodGroup" class="form-control input-lg" placeholder="*Blood group" >
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="user.Contact" id="Contact" class="form-control input-lg" placeholder="*Phone 1" >
                    <span id="errContact" class="text-danger"></span>
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="user.Contact" class="form-control input-lg" placeholder="Phone 2" >
                  
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="user.Email" id="Email" class="form-control input-lg" placeholder="*Email Address">
             ...
             <div class="personal-bg">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="user.EFName" id="EFName" class="form-control input-lg" placeholder="Name" >
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="user.EContact" id="EContact" class="form-control input-lg" placeholder="Contact no." >
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="user.EEmail" id="EEmail" class="form-control input-lg" placeholder="Email Address" >
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="user.ERelationship" id="ERelationship"  class="form-control input-lg" placeholder="Relationship with you" >
                  </div>
                </div>
              </div>
            </div>
             ...
             <div class="personal-bg">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                  <select type="text" name="user.BankName" id="BankName" class="form-control input-lg" placeholder="Name of the Bank" >
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <select type="text" name="user.BranchId" id="BranchId" class="form-control input-lg" placeholder="Branch" >
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="user.AccountNumber" id="AccountNumber" class="form-control input-lg" placeholder="Account number" >
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    
                    <select type="text" name="user.AccountType" id="AccountType"  class="form-control input-lg" placeholder="Type of account" >
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="user.IfscCode" id="IfscCode" class="form-control input-lg" placeholder="IFSC code" >
                  </div>
                </div>
              </div>
            </div>
 ...
 <input type="submit" class="btn btn-primary btn-block btn-lg" tabindex="7" >                
              </div>
            </div>
