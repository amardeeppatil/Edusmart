 ...
 <%@ page import="com.edusmartweb.edusmart.model.AboutTB" %>
...
<div class="col-md-12 home-bg">
      ...
      <form action="saveAboutDecription" method="post">
              <div class="modal fade " id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-target=".bs-example-modal-lg">
                        ...
                        <div class="panel-body">
                          <div class="">
                            ...
                            <div class="col-lg-10 profile-new">
                              <p class="lead ">
                               <input type="text" name="aboutTB.title" class="form-control" id="" placeholder="Add main title here">
                              </p>
                            ...
                            <div class="well-update profile-new">
                              ...
                              <div class="col-lg-7 ">
                                <p class="margin-top">
                                  <input type="text" name="aboutTB.subTitle" class="form-control" id="" placeholder="Add sub-title here">
                                </p>
                                <p>
                                   <textarea name="aboutTB.description" class="form-control" id="" placeholder="Add Description here" rows="5"></textarea>
                                </p>
                                <div class="clearfix"></div>
                              </div>
                              <div class="clearfix"></div>
               ...
               <a href="#" class="pull-left share" data-toggle="tooltip" title="Share" data-placement="bottom"> <img src="entireApp/images/plane.png"></a>
                            <div class="form-group pull-right">
                             <select type="text" name="aboutTB.shareType" class="form-control multiselect multiselect-icon" multiple="multiple" role="multiselect">          
    ...
    <!--  Edit News Popup-->
     <s:form action="editAboutDesc.action">
          <input type="hidden" value="" name="aboutTB.aboutId" id="DescAboutId"> 
                      ...
                      <div class="panel panel-default">
                        <div class="panel-body">
                          <div class="">
                            ...
                            <div class="col-lg-10 profile-new">
                              <p class="lead ">
                                <input type="text" name="aboutTB.title" class="form-control" id="editTitle" placeholder="Add main title here">
                              </p>
                            ...
                            <div class="well-update profile-new">
                              ...
                              <div class="col-lg-7 ">
                                <p class="margin-top">
                                  <input type="text" name="aboutTB.subTitle" class="form-control" id="editSubTitle" placeholder="Add sub-title here">
                                </p>
                                <p >
                                  <textarea name="aboutTB.description" class="form-control" id="editaboutdesc" placeholder="Add Description here" rows="5"></textarea>
                                </p>
                                <div class="clearfix"></div>
                              </div>
                              <div class="clearfix"></div>
...
<%-- <c:forEach items="${aboutUsPostList}" var="aboutObj"> --%>
	<%
     ...
     ArrayList<AboutTB> aboutUsPostList=(ArrayList) request.getAttribute("aboutUsPostList");
     
     Iterator itr=aboutUsPostList.iterator();
     while(itr.hasNext()){
    	 
    	 AboutTB aboutObj=(AboutTB)itr.next();
    	%> 	
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                      <div class="panel-body">
                        ...
                        <div class="col-lg-11 profile-new">
                          <p class="lead "> <a href="index.php"> <!-- <s:property value="academyTB.AcademyName"/> --> </a> <%-- <c:out value=" ${aboutObj.title}  "/> --%> <%=aboutObj.getTitle()%> </p>
                          <p><span class="glyphicon glyphicon-time"></span> Posted on <%-- <c:out value=" ${aboutObj.date}  "/> --%><%=aboutObj.getDate()%></p>
                        </div>
                        <div class="clearfix"></div>
                        <div class="well-update profile-new">
                          <div class="col-lg-5 "> <img alt="" src="entireApp/images/students.jpg" class="img-responsive"> </div>
                          <div class="col-lg-7 ">
                            <h4 class="margin-top"><%-- <c:out value=" ${aboutObj.subTitle}  "/> --%> <%=aboutObj.getSubTitle()%></h4>
                            <p class="comment more"><%-- <c:out value=" ${aboutObj.description}  "/> --%> <%=aboutObj.getDescription()%></p>
                            <div class="clearfix"></div>
                          </div>
                          <div class="clearfix"></div>
                        </div>
...
<!--Iterator End  -->     
              ...
              <div class="well">
                <table class="table bdr-none">
                  <tbody>
                    <tr>
                      <td>Name</td>
                      <td><s:property value="academyTB.OwnerFirstName"/></td>
                    </tr>
                    <tr>
                      <td>Location</td>
                      <td><s:property value="academyTB.City"/></td>
                    </tr>
                    <tr>
                      <td>Establishment</td>
                      <td><s:property value="academyTB.establishment"/></td>
                    </tr>
                    <tr>
                      <td>Tag Line</td>
                      <td><s:property value="academyTB.tagLine"/></td>
                    </tr>
                    <tr>
                      <td class="col-lg-3">Vision / Objectives</td>
                      <td><s:property value="academyTB.objectives"/></td>
                    </tr>
                    <tr>
                        ...
                        <div class="panel panel-default" id="panel1">
                          <div id="collapseTwo" class="panel-collapse collapse in">
                            <div class="panel-body" style="padding:0px;">
                              <p id="AboutInfoId"><s:property value="academyTB.description"/></p>
                            </div>
                          </div>
                        </div></div></td>
                      <td >
                      ...
                      <td><div class="panel-group " style="margin-top:0px;">
                        <div class="panel panel-default" id="panel1">
                          <div id="collapseThree" class="panel-collapse collapse in">
                            <div class="panel-body" style="padding:0px;">
                              <p id="AddressId"><s:property value="academyTB.address"/></p>
                            </div>
                          </div>
                        </div></div></td>
                      <td >
    ...
    <i class="fa fa-pencil blue"></i></a>
        ...
        <i class="fa fa-repeat blue"></i></a></span>
                    ...
                    <tr>
                      <td>Contact</td>
                      <td><s:property value="academyTB.Phone"/></td>
                    </tr>
                    <tr>
                      <td>Email</td>
                      <td><s:property value="academyTB.EmailId"/></td>
                    </tr>
                    <tr>
                      <td>Website</td>
                      <td><s:property value="academyTB.Website"/></td>
                    </tr>
                    <tr>
                      <td></td>
