...
function flushPost(aboutId){

	alert(aboutId);
	$.ajax({  
	    type : "post",  
	    url : "flushPost.action",   
...
<ul class="dropdown-menu width4">
  <li><input name="aboutTB.shareType" type="checkbox" value="All" />&nbsp;All</li>
  <li><input name="aboutTB.shareType" type="checkbox" value="Faculty" />&nbsp;Faculty</li>
  <li><input name="aboutTB.shareType" type="checkbox" value="Students" />&nbsp;Students</li>
  <li><input name="aboutTB.shareType" type="checkbox" value="Center" />&nbsp;Center</li>
 ...
 <%-- <s:form name="editPost">
                ...
                <div class="panel panel-default">
                  <div class="panel-body">
                    <div class="">
                      ...
                      <div class="col-lg-10 profile-new">
                        <p class="lead ">
                          <input type="text" class="form-control" id="title" value="<s:property value="aboutTB.title"/>">
                        </p>
                      </div>
                      <div class="clearfix"></div>
                      <div class="well-update profile-new">
                        ...
                        <div class="col-lg-7 ">
                          <p class="margin-top">
                            <input type="text" class="form-control" id="subTitle" value="<s:property value="aboutTB.subTitle"/>">
                          </p>
                          <p >
                  ...
                  <div class="panel-footer">
                    <div class="row">
                      <div class="col-md-7">
                        <div class="form-group">
                          <div class="btn-group">
                            <button type="submit" class="btn btn-primary" onclick="editPost()">Submit</button>
                          </div>
                          <div class="btn-group">
                            <button type="reset" class="btn btn-default">Reset</button>
                          </div>
     ...
     ArrayList<AboutTB> aboutPostList=(ArrayList) request.getAttribute("academyProfilePostList");
     
     Iterator itr=aboutPostList.iterator();
     while(itr.hasNext()){
    	 
    	AboutTB about=(AboutTB) itr.next(); 
    	%> 
    	 
     
			
 <%-- <c:forEach items="${academyProfilePostList}" var="about"> --%>       
        <div class="bg-white "> <span style="float:right;margin-right: 11px;" id="edit1"> <a href="#" data-toggle="modal" data-target="#exampleModal2" data-whatever="" > <i class="fa fa-pencil"></i></a> <span style="float:left;margin-right: 11px;" ><a href="#" onclick="flushPost(${about.aboutId})" data-toggle="tooltip" title="Delete" data-placement="bottom"> <i class="fa fa-trash-o blue"></i></a></span> </span> <span  style="display:none;float:right;margin-right: 11px;" id="done"> <i class="fa fa-floppy-o"></i> <span style="float:left;margin-right: 11px;" ><a href="#" data-toggle="tooltip" title="Reset" data-placement="bottom"> <i class="fa fa-repeat blue"></i></a></span> </span>
            ...
            <div class="panel panel-default" id="panel1">
              <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                  ...
                  <div class="col-lg-10 profile-new">
                  <p class="lead "> <a href="#"><!-- <s:property value="academy.AcademyName"/> --></a> <%-- <c:out value=" ${about.title}  "/> --%><%=about.getTitle()%> </p>
                  <p><span class="glyphicon glyphicon-time"></span> Posted on <%-- <c:out value=" ${about.date}  "/> --%> <%=about.getDate()%></p>
                  </div>
                  <div class="clearfix"></div>
                  <div class="well-update profile-new">
                    <div class="col-lg-5 "> <img alt="" src="entireApp/images/students.jpg" class="img-responsive"> </div>
                    <div class="col-lg-7 ">
                      <h4 class="margin-top"><%-- <c:out value=" ${about.subTitle}  "/> --%> <%=about.getSubTitle()%></h4>
                      <p class="comment more"><%-- <c:out value=" ${about.description}  "/> --%> <%=about.getDescription()%></p>
                      <div class="clearfix"></div>
                    </div>
                    <div class="clearfix"></div>
                  </div>
