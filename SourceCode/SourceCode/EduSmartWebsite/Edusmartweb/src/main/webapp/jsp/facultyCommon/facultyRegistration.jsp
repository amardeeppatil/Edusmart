  ...
  <div class="container-fluid">
    ...
    <!--<div id="loginbox" style="margin-top:50px;background:#fff;padding:30px;padding-top:0px;"class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
      ...
      <div class="bar" style="width: 36%;"></div>
          ...
          <div class="panel with-nav-tabs panel-info "><br>
                <div class="panel-heading p-head panel-info1">
                        <ul class="nav nav-tabs nav-tb">
                            ...
                            <li class=""><a href="#tab2info" data-toggle="tab">Faculty Account</a></li>
            ...
            <div class="login-pic"> <img class="" src="images/students.jpg" alt="..." width="100%"> </div>
          ...
          <form action="personalDataSave.action"  method="post">
            ...
            <div class="personal-bg">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="userProfileTB.EFName" id="first_name" required pattern="[a-zA-Z]+" title="Only enter letters" class="form-control input-lg" placeholder="Name" >
                  </div>
                </div>
              </div>
              <div class="form-group">
                <input type="text" name="userProfileTB.DOB" id="display_name" class="form-control input-lg" placeholder="Date of Birth" >
              </div>
              
              
                  <div class="form-group">
                    <input type="text" name="userProfileTB.CAddress1" required pattern="[a-zA-Z]+" title="Only enter letters" id="first_name" class="form-control input-lg" placeholder="Address" >
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group">
                    <select type="text" name="userProfileTB.BloodGroup" id="display_name" class="form-control input-lg" placeholder="Blood group" >
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="userProfileTB.Contact" id="first_name" maxlength="10" required pattern="[0-9]{10}"  class="form-control input-lg" placeholder="Phone 1" >
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
            ...
            <div class="personal-bg">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="userProfileTB.EFName" maxlength="10" required pattern="[0-9]{10}" id="first_name" class="form-control input-lg" placeholder="Name" >
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="userProfileTB.EContact" id="first_name" maxlength="10" required pattern="[0-9]{10}" class="form-control input-lg" placeholder="Contact no." >
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="email" name="userProfileTB.EEmail" id="first_name" class="form-control input-lg" placeholder="Email Address" >
                  </div>
                </div>
            ...
            <div class="personal-bg">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="userProfileTB.AccountNumber" id="first_name" class="form-control input-lg" placeholder="Account number" >
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="userProfileTB.AccountType" id="first_name" class="form-control input-lg" placeholder="Type of account" >
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <input type="text" name="userProfileTB.IfscCode" id="first_name" class="form-control input-lg" placeholder="IFSC code" >
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xs-12 col-md-6">
                <input type="submit" value="Submitsss"  class="btn btn-primary btn-block btn-lg" tabindex="7">
              </div>
            </div>
            ...
            <!-- End --Personal Info Save  -->
                  ...
                  <div class="col-lg-12">
               <form action="facultyInfoSave.action" method="post">
                    <div class="personal-bg">
                      <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <div class="form-group " >
                            ...
                            <div class="radio-inline">
                              <label style="font-size:15px;font-weight:normal;margin-top:10px;">
                                <input type="radio" value="Deactive" id="facultyTb.optionsRadios2" name="status">
                                Deactive </label>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <div class="input-group stylish-input-group">
                            <input type="text" class="form-control input-lg" placeholder="Search your academy name">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <div class="form-group">
                            <input type="text" name="state" id="state" class="form-control input-lg" placeholder="Add your academy name" >
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <div class="form-group">
                            ...
                            <div class="controls" style="width:100%; font-size: 14px;">
                              <input type="radio"  name="courseTB.course[]" value="Yes"  class="static_class1" />
                              Yes &nbsp;
                              </label>
                              <input type="radio"  name="courseTB.course[]" value="No"  class="static_class1"/>
                              No
                              </label>
                            </div>
                          </div>
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="button-group col-lg-3 col-xs-4 col-sm-4 col-md-4 mg-top" >
                              ...
                              <ul class="dropdown-menu" style="height:130px;overflow:scroll;"  >
                                <li><a tabindex="-1" data-value="option1" name="subject" class="small" href="#">
                                  <input type="checkbox" >
                                  &nbsp;Option 1</a></li>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <div class="form-group">
                            ...
                            <div class="controls" style="width:100%; font-size: 14px;">
                              <input type="radio"  name="actions2" value="Yes"  class="static_class2" />
                              Yes &nbsp;
                              </label>
                              <input type="radio"  name="actions2" value="No"  class="static_class2"/>
                              No
                              </label>
                            </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <div class="form-group">
                            ...
                            <div class="controls" style="width:100%; font-size: 14px;">
                              <input type="radio"  name="actions3" value="Yes"  class="static_class3 lb" />
                              Yes &nbsp;
                              </label>
                              <input type="radio"  name="actions3" value="No"  class="static_class3 lb"/>
                              No
                              </label>
                            </div>
                          </div>
