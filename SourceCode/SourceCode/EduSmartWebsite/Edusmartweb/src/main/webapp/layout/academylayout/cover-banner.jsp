...
<style>
		...
		#nav
		{
			...
			#nav > a
			{
				display: none;background:#337AB7 !important;color:#E06D09 !important;
			}
			...
			#nav > ul
			{
				...
				background-color: #E06D09;padding:0px;
			}
		.right {
    ...
    border-width: 1px;
    border-image: 
        -webkit-gradient(linear, right center, from(#f00), to(#f00), )1 repeat repeat
}
				...
				#nav > ul > li
				{
					...
					height: 100%;
					float: left;
					  background: url(entireApp/images/divider.png) no-repeat right center;
				}
				#nav > ul > li.last{background-image: none !important;}
					#nav > ul > li > a
					{
						...
						{
							background-color: #eeeeee;color:#E06D09;
						}
				...
				#nav li ul
				{
					...
					top: 100%;padding:0px;z-index:9999;border-left:1px solid #eaeaea;border-right:1px solid #eaeaea;border-bottom:1px solid #eaeaea;
  ...
  box-shadow: 0 6px 12px rgba(0,0,0,.300);
					...
					#nav li:hover ul
					{
						...
						#nav li ul a
						{
							...
							padding:6px 10px; text-decoration:none;color:#000;
    ...
    <div class="panel-new">
                 ...
                 <span class=" btn-file "> <i class="fa fa-camera " style="color:#fff;"></i>
                    Change cover   <input type="file"> </span></a>
                    
                    <img class="pic" src="entireApp/images/profile.jpg" alt="...">
                   
                    <div class="name">
                    <div>  <span class=" btn-file photo-icon"> <a href="#"><i class="fa fa-camera "></i></a>
            <input type="file"> </span></div>
                    <small>Edusmart</small><br><span class="pull-right">Pune, MS</span></div>
                    
              <img src="entireApp/images/1.jpg" width="100%">
       </div>
	...
	<ul class="clearfix">	
		<li><a href="academyProfile">Timeline</a></li>
        	<li class=""><a href="aboutPage">About</a></li>
            	<li><a href="facultyProfile">Faculty</a></li>
                	<li><a href="#">Center</a></li>
                    	<li><a href="#">Classes</a></li>
                        
		
		<li class="drop last">
			<a href="" aria-haspopup="true"><span>More..</span></a>
			<ul>
				<li><a action="show"><i class="fa fa-bullhorn"></i> News</a></li>
         <li><a href="#"><i class="fa fa-picture-o"></i>  Gallery</a></li>
         <li><a href="#"><i class="fa fa-pencil-square-o"></i>  Reviews</a></li>
         <li><a href="events.action"><i class="fa fa-calendar"></i>  Events</a></li>
