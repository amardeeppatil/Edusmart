...
<!-- Faculty List -->
     ...
     ArrayList<UserProfileTB> facultyList=(ArrayList) request.getAttribute("facultyList");
     
     Iterator itr=facultyList.iterator();
     while(itr.hasNext()){
    	 
    	UserProfileTB listFaculty=(UserProfileTB) itr.next();
    	%> 	
    	
    	
    	<div class="col-md-3 col-xs-4 col-lg-4 firends">
					<a action="facultyProfile">
						<img class="featurette-image img-responsive"
							src="entireApp/images/Prathamesh_Talathi_logo.jpg">
							
						<%=listFaculty.getFName()%>
...
<div class="content ">
     ...
     ArrayList<UserProfileTB> centerList=(ArrayList) request.getAttribute("centerList");
     
     Iterator itr1=centerList.iterator();
     while(itr1.hasNext()){
    	 
    	UserProfileTB listCenter=(UserProfileTB) itr1.next();
    	%> 		
       <div class="col-md-3 col-xs-4 col-lg-4 firends">
        <a href="#"> <!-- <img class="featurette-image img-responsive" src="entireApp/entireApp/images/user.png"> -->
        <img class="featurette-image img-responsive"src="entireApp/images/Ajinkya_Marathe_logo.jpg">
        <%=listCenter.getCCity()%>
         </a>
        </div>
