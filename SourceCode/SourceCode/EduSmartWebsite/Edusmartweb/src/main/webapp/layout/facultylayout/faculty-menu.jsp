...
<div class="mn" style="background:#E06D09;">
	...
	<ul class="clearfix">
		<li><a href="academyProfile.action">Timeline</a></li>
		...
		<li class="drop last">
			...
			<ul>
				<li><a href="show.action"><i class="fa fa-bullhorn"></i>  News</a></li>
         ...
         <li><a href="files.php"><i class="fa fa-folder-open"></i>  Files</a></li>
