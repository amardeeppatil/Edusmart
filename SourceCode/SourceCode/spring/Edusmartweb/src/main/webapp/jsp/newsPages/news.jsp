...
<div class="col-md-12 home-bg ">
        <div data-example-id="togglable-tabs" role="tabpanel" class=" bs-example-tabs tab	">
         ...
         <!--  Add news popup-->
           ...
           <form:form action="saveNewsAnnousement" commandname="newsCmd">
                    ...
                    <div class=" pull-left col-lg-4">
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                          <li>
                            <input type="radio" id="ex7_3"  name="type"  value="News" checked>
                            <label for="ex7_3"><i class="fa fa-bullhorn data-label"></i> News</label>
                          </li>
                          <li>
                            <input type="radio" id="ex7_4"  name="type"  value="Announcement">
                    ...
                    <div class="pull-right col-lg-8"> <span style="font-size: 10px; font-style: italic;  position: absolute;  bottom: 36px;  left: 147px;">You Planner(optional)
                      ...
                      <div class="form-group col-lg-6">
                        <div class="input-group date " id="dp2"> <span class="input-group-addon in"><i class="fa fa-calendar"></i> </span>
                          <input type="text" class="datepicker form-control date-width lg"  name="entryDate" id="txtStartDateDesk"  placeholder="Select Start date"//>
                        </div>
                      </div>
                      <div class="form-group  col-lg-6">
                        <div class="input-group date " id="dp1"> <span class="input-group-addon in"><i class="fa fa-calendar"></i> </span>
                          <input type="text" class="datepicker form-control date-width lg" name="expDate" id="txtStartDateDesk" placeholder="Select End date"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-body">
                        <div class="">
                          ...
                          <div class="col-lg-11 profile-new">
                            <p class="lead ">
                              <input type="text" class="form-control" id="" placeholder="Add main title here" name="title">
                            </p>
                          </div>
                          <div class="clearfix"></div>
                          <div class="well-update profile-new">
                            <div class="col-lg-5"> <img alt="" src="entireApp/images/news.png" class="img-responsive"> <a href="#" class="btn btn-xs btn-primary pull-left " style="margin-top:10px;"> <span class=" btn-file "> <i class="fa fa-camera " style="color:#fff;"></i> Your Gallery
                              <input type="file">
                            ...
                            <div class="col-lg-7 ">
                              <h4 class="margin-top">
                                <input type="text" class="form-control" id="" placeholder="Add sub-title here" name="subTitle">
                              </h4>
                              <p >
                                <textarea type="text" class="form-control" name="newsContent" id="" placeholder="Add Description here" rows="5"></textarea>
                              </p>
                              <div class="clearfix"></div>
                            </div>
                            <div class="clearfix"></div>
                      ...
                      <div class="panel-footer">
                        <div class="row">
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              <select class="form-control privacy-dropdown pull-right input-sm" name="shareWith" style="  margin-right: 10px;">
                                <option selected="selected" value="Academy">Academy</option>
                                <option value="Faculty">Faculty</option>
                                <option value="Students">Students</option>
                                <option value="Center">Center</option>
                              </select>
                              <a href="#" class="pull-right share" data-toggle="tooltip" title="Share" data-placement="bottom"> <img src="entireApp/images/plane.png"></a>
                              <style>
   .datepicker.dropdown-menu{z-index:9999999999991}
          ...
          <input type="hidden" value="" name="newsId" id="updateNewsId">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body"> <span class=" pull-left col-lg-4">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <li>
                          <input type="radio" id="ex7_5" name="type"  value="News" checked>
                          <label for="ex7_5"><i class="fa fa-bullhorn data-label"></i> News</label>
                        </li>
                        <li>
                          <input type="radio" id="ex7_6" name="type" value="Announcement">
  ...
  left: 147px;">You Planner(optional)
                      ...
                      <div class="form-group col-lg-6">
                        <div class="input-group date " id="dp2"> <span class="input-group-addon in"><i class="fa fa-calendar"></i> </span>
                          <input type="text" class="datepicker form-control date-width lg" id="editEntryDate" name="entryDate"  placeholder="Select Start date"//>
                        </div>
                      </div>
                      <div class="form-group  col-lg-6">
                        <div class="input-group date " id="dp1"> <span class="input-group-addon in"><i class="fa fa-calendar"></i> </span>
                          <input type="text" class="datepicker form-control date-width lg" id="editExpDate" name="expDate" placeholder="Select End date"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-body">
                        <div class="">
                          ...
                          <div class="col-lg-11 profile-new">
                            <p class="lead ">
                              <input type="text" class="form-control" id="editTitle" placeholder="Add main title here" name="title">
                            </p>
                          </div>
                          <div class="clearfix"></div>
                          <div class="well-update profile-new">
                            ...
                            <div class="col-lg-7 ">
                              <h4 class="margin-top">
                                <input type="text" class="form-control" id="editSubTitle" placeholder="Add sub-title here" name="subTitle">
                              </h4>
                              <p >
                                <textarea  class="form-control" id="editNewsContent" placeholder="Add Description here" rows="5" name="newsContent"></textarea>
                              </p>
                              <div class="clearfix"></div>
                            </div>
                            <div class="clearfix"></div>
...
<c:forEach items="${newsList}" var="newsObj">
              ...
              <a href="#" onclick="deleteNews(${newsObj.newsId})"   data-toggle="tooltip" title="Delete" data-placement="bottom"> 
                  ...
                  <div class="panel panel-default" id="panel1">
                    <div id="collapseOne" class="panel-collapse collapse in">
                      <div class="panel-body">
                        ...
                        <div class="col-lg-11 profile-new">
                          <p class="lead "> <a href="#"><c:out value="${newsObj.title}"/> </a> </p>
                        ...
                        <div class="well-update profile-new">
                          ...
                          <div class="col-lg-7 ">
                            <h4 class="margin-top"><c:out value=" ${newsObj.subTitle}"/></h4>
                ...
                <%--  <c:out value="${object.userProfileTB.userId}"></c:out> --%>
                 <c:set var="getUserId" value="${object.userProfileTB.userId}"/>
                 <c:set var="commentLikeObj" value="${CommentLikeList}"/>
            ...
            <c:out value="${userId}"></c:out>
                 ...
                 <fmt:parseNumber var="likebyVar" type="number" value="${commentLikeObj.likeById}" />
                  <c:set var="likeByIdList" value="${commentLikeObj.likeByIdList}"/>
                   
               <%--     
                  1]  <c:out value="${newsIdNews}"></c:out>
                   2]  <c:out value="${NewsIdComment}"></c:out>
                    3]  <c:out value="${likebyVar}"></c:out>
                     4]  <c:out value="${likeByIdList}"></c:out>
                   ==== --%>
                   
                   
                     <c:if test="${newsIdNews == NewsIdComment}">
                     <%
                      String getUserId=Integer.toString((Integer)pageContext.getAttribute("getUserId"));
                      String likeByIds= (String)pageContext.getAttribute("likeByIdList");
                      
                      
                      if(likeByIds.contains(getUserId)==true){ %>
                      <% flag=1; %>
                      
              				 <li> <a onclick="likeCount(${newsObj.newsId})" title="" name="commentLikeTb.newsId" ><span id="like${newsObj.newsId}">Unlike</span> </a><span class="like" id="likeCnt${newsObj.newsId}">/ ${commentLikeObj.likeCount}</span>.</li>
              				 <li> <a href="#" > Comment </a><span class="comment">/ 12</span> .</li>
				<% }%>
                 <%if(flag!=1){ %>
                  <c:set var="likecnt" value="${commentLikeObj.likeCount}"/>
                 <%} %> 
                     </c:if> 
                 ...
                 <%if(flag!=1){ %>
        <li> <a onclick="likeCount(${newsObj.newsId})" title="" name="commentLikeTb.newsId" ><span id="like${newsObj.newsId}">Like</span> </a><span class="like" id="likeCnt${newsObj.newsId}">/ <%=pageContext.getAttribute("likecnt") %></span></li>
        <li> <a href="#" > Comment </a><span class="comment">/ 12</span> </li>
              ...
              <div class="bottom-bg">
                ...
                <div class="clearfix"></div>
                <div class="col-md-2 col-xs-3   col-lg-1 firends1 home-img"> <img src="entireApp/images/user.png" class="featurette-image img-responsive"></div>
                <form:form onsubmit="commentSaveFun(${newsObj.newsId})">
                <div class="col-lg-10 col-sm-10 col-xs-10 left-none">
                     <input type="text" id="commentData${newsObj.newsId}" name="comment${newsObj.newsId}" class="form-control" placeholder="Write a comment..."> 
                </div>
            ...
            <c:forEach items="${pastNewsList}" var="pastsNewsObj">
              ...
              <div class="bottom-bg">
                <form>
                  <div class="col-lg-1  col-sm-3 col-xs-3"> <img src="entireApp/images/user.png" class="featurette-image img-responsive" style="margin-top: 5px;"> </div>
...
function commentSaveFun(newsId)

{    
	var contents=$("#commentData"+newsId).val();
	alert(contents);
  $.ajax({
    type: "post",
    url: "commentSave",
    data: "newsId="+newsId+"&value="+contents,
    success: function(response){      
            alert("call");
    }
}); 
