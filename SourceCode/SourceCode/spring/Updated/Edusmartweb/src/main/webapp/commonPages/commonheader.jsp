 ...
 <ul class="col-lg-12">
      <li class="p-left"><a href="home" data-toggle="tooltip" title="Home" data-placement="bottom" ><i class="fa fa-home fa-lg orange" ></i></a>
         ...
         <div class="well-update1 profile-new1  classes ">
          ...
          <div class="content">
           <h4><i class="fa fa-bell "></i></span>  Inbox    <span>(${fn:length(sessionScope.messageList)})</span><span class="pull-right see-all"><a onclick ="allNotification()" style="color:#E06D09;" data-toggle="tooltip" title="See all" data-placement="bottom">See All </a></span></h4><hr>
           ...
           <c:if test="${not empty sessionScope.notificationList}">
            ...
            <h4 class="margin-top"><c:out value=" ${msgObj.date} "/></h4><span class="pull-right"> <c:out value="${notificationListObj.notificationDate}"/> </span>
        
            <p ><c:out value="${msgObj.subject}"/></p>
        ...
        <div class="dropdown-menu noti pull-left bdr" role="menu">
         <div class="well-update1 profile-new1  classes ">
          ...
          <div class="content">
           <h4><i class="fa fa-bell "></i></span>  Notification    <span></span><span class="pull-right see-all"><a onclick ="allNotification()" style="color:#E06D09;" data-toggle="tooltip" title="See all" data-placement="bottom">See All </a></span></h4><hr>
...
window.location.href="academyNotification";
