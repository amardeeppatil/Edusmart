...
<div id="main-wrapper">
			...
			<div id="slider" class="sl-slider-wrapper">
				...
				<div class="sl-slider">
					...
					<div class="sl-slide item1" data-orientation="horizontal"
						...
						<img class="pull-right" src="resources/img/banner-image-1.png" alt="" />
					</div>
					<!--/Slider Item1-->
					...
					<div class="sl-slide item2" data-orientation="vertical"
						...
						<img class="pull-right" src="resources/img/banner-image-2.png" alt="" />
					</div>
					<!--Slider Item2-->
					...
					<div class="sl-slide item3" data-orientation="horizontal"
						...
						<img class="pull-right" src="resources/img/banner-image-3.png" alt="" />
					</div>
					<!--Slider Item3-->
	...
	<div class="span3">
		<br>
		<div>
			<img src="resources/img/team-member-1.jpg" alt="" class="img-circle pull-left"
		...
		<div class="container-fluid"
			...
			<ul class="courses-box">
				<li class="span4 text-center bx"
					...
					<div class="preview">
						<br> <img src="resources/img/CA.png" onMouseOver="shows('CA')"
				...
				<li class="span4 text-center bx"
					...
					<div class="preview">
						<br> <img src="resources/img/CS.png" onMouseOver="shows('CS')"
					...
					<div id="CS" style="display: none;" onMouseOver="shows('CS')">
						<div class="subcourse">
							<!--  <img src="resources/img/3.jpg" alt=" " width="100%" style="max-height:400px">-->
				...
				<li class="span4 text-center bx"
					...
					<div class="preview">
						<br> <img src="resources/img/CMA.png" onMouseOver="shows('CMA')"
