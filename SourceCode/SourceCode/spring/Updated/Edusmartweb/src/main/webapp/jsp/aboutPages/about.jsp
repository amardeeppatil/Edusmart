                        ...
                        <div class="panel-body">
                          <div class="">
                            ...
                            <div class="col-lg-10 profile-new">
                              <p class="lead ">
                               <input type="text" name="title"  tabindex="1"  autofocus="autofocus" maxlength="50"   class="form-control" id="" placeholder="Add main title here">
                              </p>
                            ...
                            <div class="well-update profile-new">
                              ...
                              <div class="col-lg-7 ">
                                <p class="margin-top">
                                  <input type="text"  maxlength="50"  tabindex="2"   name="subTitle" class="form-control" id="" placeholder="Add sub-title here">
                                </p>
                                <p>
                                   <textarea name="description" maxlength="200"  tabindex="3"   class="form-control" id="" placeholder="Add Description here" rows="5"></textarea>
                                </p>
                                <div class="clearfix"></div>
                              </div>
                              <div class="clearfix"></div>
                          ...
                          <div class="row">
                            <div class="col-md-7">
                              <div class="form-group">
                                ...
                                <div class="btn-group">
                                  <button type="reset" class="btn btn-default"  tabindex="5"  >Reset</button>
                                </div>
                              </div>
                            </div>
                            <div class="col-md-5">
                      ...
                      <div class="panel panel-default">
                        <div class="panel-body">
                          <div class="">
                            ...
                            <div class="col-lg-10 profile-new">
                              <p class="lead ">
                                <input type="text" name="title" maxlength="50" class="form-control" id="editTitle" placeholder="Add main title here">
                              </p>
                            ...
                            <div class="well-update profile-new">
                              ...
                              <div class="col-lg-7 ">
                                <p class="margin-top">
                                  <input type="text" maxlength="50" name="subTitle" class="form-control" id="editSubTitle" placeholder="Add sub-title here">
                                </p>
                                <p >
                                  <textarea name="description" maxlength="200" class="form-control" id="editaboutdesc" placeholder="Add Description here" rows="5"></textarea>
                                </p>
                                <div class="clearfix"></div>
                              </div>
                              <div class="clearfix"></div>
                        ...
                        <div class="panel-footer">
                          <div class="row">
                            <div class="col-md-7">
                              <div class="form-group">
                                <div class="btn-group">
                                sssssssssss  <button type="submit" class="btn btn-primary">Submit</button>
                                </div>
                                <div class="btn-group">
...
<div class="clearfix"></div>
 <a class="confirm col-lg-6 top-rht" data-dismiss=""><button type="button" class="btn btn-success btn-xs" onclick="removePost(${aboutObj.aboutId})">Confirm</button></a>
...
<a class="close col-lg-6 top-rht" data-dismiss=""><button type="button" class="btn btn-warning btn-xs" onClick="hideDeleteMsg(${aboutObj.aboutId})"> Cancel</button></a>
      ...
      <span data-toggle="modal" data-target="#exampleModal2" data-whatever="" onclick="editFunction('${aboutObj.title}','${aboutObj.subTitle}','${aboutObj.description}','${aboutObj.aboutId}')"> <i class="fa fa-pencil"></i></span> 
      <span style="float:left;margin-right: 11px;" >
      <span onclick="Show_Div(${aboutObj.aboutId})" data-toggle="tooltip" title="Delete" data-placement="bottom"> <i class="fa fa-trash-o blue"></i></span></span> 
      </span> 
      <span  style="display:none;float:right;margin-right: 11px;"> <i class="fa fa-floppy-o"></i> <span style="float:left;margin-right: 11px;" ><a href="#" data-toggle="tooltip" title="Reset" data-placement="bottom"> <i class="fa fa-repeat blue"></i></a></span> </span>
...
<!--Iterator End  -->     
          ...
          <div class="clearfix"></div>
           ...
           <div aria-labelledby="profile-tab" id="profile" class="tab-pane fade" role="tabpanel">
              ...
              <div class="well">
              <c:forEach items="${academyList}" var="academyObj">
                <table class="table bdr-none">
                  <tbody>
                    <tr>
                      <td>Name</td>
                      <td><c:out value=" ${academyObj.ownerFirstName} "/></td>
                    </tr>
                    <tr>
                      <td>Location</td>
                      <td><c:out value=" ${academyObj.city} "/></td>
                    </tr>
                    <tr>
                      <td>Establishment</td>
                      <td><c:out value="${academyObj.establishment}"/></td>
                    </tr>
                    <tr>
                      <td>Tag Line</td>
                      <td><c:out value="${academyObj.tagLine}"/></td>
                    </tr>
                    <tr>
                      <td class="col-lg-3">Vision / Objectives</td>
                      <td><c:out value="${academyObj.objectives}"/></td>
                    </tr>
                    <tr>
                        ...
                        <div class="panel panel-default" id="panel1">
                          <div id="collapseTwo" class="panel-collapse collapse in">
                            <div class="panel-body" style="padding:0px;">
                              <p id="AboutInfoId"><c:out value="${academyObj.description}"/></p>
                            </div>
                          </div>
                        </div></div></td>
                      <td >
                      ...
                      <td><div class="panel-group " style="margin-top:0px;">
                        <div class="panel panel-default" id="panel1">
                          <div id="collapseThree" class="panel-collapse collapse in">
                            <div class="panel-body" style="padding:0px;">
                              <p id="AddressId"><c:out value="${academyObj.address}"/></p>
                            </div>
                          </div>
                        </div></div></td>
                      <td >
    ...
    <i class="fa fa-pencil blue"></i></a>
        ...
        <i class="fa fa-repeat blue"></i></a></span>
                    ...
                    <tr>
                      <td>Contact</td>
                      <td><c:out value="${academyObj.phone}"/></td>
                    </tr>
                    <tr>
                      <td>Email</td>
                      <td><c:out value="${academyObj.emailId}"/></td>
                    </tr>
                    <tr>
                      <td>Website</td>
                      <td><c:out value="${academyObj.website}"/></td>
                    </tr>
                    <tr>
                      <td></td>
                    ...
                    <div class="panel-body" style="padding:0px;">
                      <div class="col-lg-5 left-none abt"><br>
                        ...
                        <p style="font-size:14px;">Designation - CA<br>
                          Contact No. - <c:out value="${academyObj.phone}"/><br>
                          Email ID -<c:out value="${academyObj.emailId}"/><br>
                          Joining Date- <c:out value="${academyObj.establishment}"/></p>
                      </div>
                      <div class="col-lg-5 left-none abt">
                        <h2>Description</h2>
                        <p style="font-size:14px;"><c:out value="${academyObj.aboutInfo}"/></p>
                      </div>
                    </div>
                  </div>
                </div>
