...
function Show_Div(divId) {
    ...
    <form:form  id="saveAcademyId" action="saveAcademyPost" commandName="postData"><!--onclick="saveAcademy()"  -->
                  ...
                  <div class="panel-body">
                    <div class="">
                      ...
                      <div class="col-lg-10 profile-new">
                        <p class="lead ">
                          <input type="text" name="title" autofocus="autofocus" tabindex="1"  class="form-control"  maxlength="50" id="" placeholder="Add main title here">
                        </p>
                      </div>
                      ...
                      <div class="well-update profile-new">
                        ...
                        <div class="col-lg-7 ">
                          <p class="margin-top">
                            <input type="text" name="subTitle"  tabindex="2"   class="form-control" id="" maxlength="50" placeholder="Add sub-title here">
                          </p>
                          <p >
                            <textarea name="description" class="form-control" id=""  tabindex="3"    maxlength="200" placeholder="Add Description here" rows="5"></textarea>
                          </p>
                    ...
                    <div class="row">
                      <div class="col-md-7">
                        <div class="form-group">
                          ...
                          <div class="btn-group">
                            <button type="button" class="btn btn-default"  tabindex="5"  >Reset</button>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-5">
...
<ul class="dropdown-menu width4">
                ...
                <div class="panel panel-default">
                  <div class="panel-body">
                    <div class="">
                      ...
                      <div class="col-lg-10 profile-new">
                        <p class="lead ">
                          <input type="text" name="title"  tabindex="1"   maxlength="50" class="form-control" id="editTitle" placeholder="Add main title here">
                        </p>
                      </div>
                      <div class="clearfix"></div>
                      <div class="well-update profile-new">
                        ...
                        <div class="col-lg-7 ">
                          <p class="margin-top">
                            <input type="text"  tabindex="2" autofocus="autofocus" name="subTitle" maxlength="50" class="form-control" id="editSubTitle" placeholder="Add sub-title here">
                          </p>
                          <p >
                            <textarea name="description" maxlength="200"  tabindex="3"   class="form-control" id="editPostdesc" placeholder="Add Description here" rows="5"></textarea>
                          </p>
                          <div class="clearfix"></div>
                        </div>
                        <div class="clearfix"></div>
                    ...
                    <div class="row">
                      <div class="col-md-7">
                        <div class="form-group">
                          ...
                          <div class="btn-group">
                            <button type="button" class="btn btn-default" onclick="postReset()"  tabindex="5"  >Reset</button>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-5">
 ...
 <c:forEach items="${academyProfilePostList}" var="about">    
        ...
        <div class="bg-white "> 
        <div id="demo${about.aboutId}" style="display:none;position:absolute; z-index: 999; right: 35px;top: 24px;">
 <div class="alert alert-block delete-pop" >
 <p>Are you sure want to delete?</p>
<div class="clearfix"></div>
 <a class="confirm col-lg-6 top-rht" data-dismiss=""><button type="button" class="btn btn-success btn-xs" onclick="removePost(${about.aboutId})">Confirm</button></a>

<a class="close col-lg-6 top-rht" data-dismiss=""><button type="button" class="btn btn-warning btn-xs" onClick="hideDeleteMsg(${about.aboutId})"> Cancel</button></a>
</div></div>
        
        <span style="float:right;margin-right: 11px;" id="edit1">
       
       
         <a href="#" data-toggle="modal" data-target="#exampleModal2" data-whatever="" onclick="editFunction('${about.title}','${about.subTitle}','${about.description}','${about.aboutId}')" > 
         <i class="fa fa-pencil"></i></a>
         
          <span style="float:left;margin-right: 11px;" >
          <span class="cursor" onclick="Show_Div(${about.aboutId})" data-toggle="tooltip" title="Delete" data-placement="bottom"> <i class="fa fa-trash-o blue"></i></span></span> </span> <span  style="display:none;float:right;margin-right: 11px;" id="done"> <i class="fa fa-floppy-o"></i> <span style="float:left;margin-right: 11px;" ><a href="#" data-toggle="tooltip" title="Reset" data-placement="bottom"> <i class="fa fa-repeat blue"></i></a></span> </span>
